...
TEST_TIME_HOUR = 1   # 01:20
TEST_TIME_MINUTE = 20  # 01:20
...
class Scheduler:
    ...
    async def _send_reminder(self):
        ...
        # New description with channel link
    ...
    async def _test_poll_loop(self):
        # Run once at 01:20 Europe/London
        await self._wait_until_next_london_time(1, 20)
