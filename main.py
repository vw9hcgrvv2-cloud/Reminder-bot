...
TEST_TIME_HOUR = 1
TEST_TIME_MINUTE = 30  # First test reminder at 01:30 Europe/London
...
class Scheduler:
    ...
    async def _send_reminder(self):
        ...
        # Description with channel link
        embed.description = "Remember to vote in <#1524445184853803069>"
    ...
    async def _reminder_loop(self):
        # First reminder at 01:30 Europe/London, then every 15 minutes
        await self._wait_until_next_london_time(1, 30)
        while True:
    ...
    async def _test_poll_loop(self):
        # Run once at 01:30 Europe/London
        await self._wait_until_next_london_time(1, 30)
...
# Also ensure the scheduler starts when the bot connects
@bot.event
